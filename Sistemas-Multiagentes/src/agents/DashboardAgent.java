...
public class DashboardAgent extends Agent {
    ...
    static String URL_1 = "https://es.wikipedia.org/wiki/Boston";
    static String URL_2 = "https://es.wikipedia.org/wiki/Chicago";
    static String URL_3 = "https://es.wikipedia.org/wiki/Seattle";
    ...
    protected void setup() {
        ...
        msgContent.add(WEB_AGENT_1 + ":" + URL_1);
        msgContent.add(WEB_AGENT_2 + ":" + URL_2);
        msgContent.add(WEB_AGENT_3 + ":" + URL_3);
...
private class Form extends JFrame {
